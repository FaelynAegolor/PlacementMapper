...
export const SAMPLE_PLACEMENTS: Omit<Placement, "id">[] = [
  ...
  {
    name: "The Portland Hospital (private)",
    postcode: "W1W 5AH",
    category: "paediatric",
    yearsOffered: [1, 2, 3],
    requiresDriver: false,
  ...
  {
    name: "The Wellington Hospital (private)",
    postcode: "NW8 9LE",
    category: "adult",
    yearsOffered: [2, 3],
    requiresDriver: false,
  ...
  {
    name: "London Bridge Hospital (private)",
    postcode: "SE1 2PR",
    category: "adult",
    yearsOffered: [2, 3],
    requiresDriver: false,
  ...
  {
    name: "The Harley Street Clinic (private)",
    postcode: "W1G 8BJ",
    category: "adult",
    yearsOffered: [2, 3],
    requiresDriver: false,
  ...
  {
    name: "Islington School Nursing Service",
    postcode: "N1 2UD",
    category: "paediatric",
    yearsOffered: [1, 2, 3],
    requiresDriver: true,
  ...
  {
    name: "Newham School Health Team",
    postcode: "E16 2QU",
    category: "paediatric",
    yearsOffered: [2, 3],
    requiresDriver: true,
  ...
  {
    name: "Southwark School Nursing Service",
    postcode: "SE1 2QH",
    category: "paediatric",
    yearsOffered: [1, 2, 3],
    requiresDriver: false,
  ...
  {
    name: "Tower Hamlets Health Visiting Team",
    postcode: "E14 2BG",
    category: "paediatric",
    yearsOffered: [2, 3],
    requiresDriver: true,
  ...
  {
    name: "Wandsworth Adult Community Team",
    postcode: "SW18 2PU",
    category: "adult",
    yearsOffered: [2, 3],
    requiresDriver: true,
  ...
  {
    name: "Lewisham Community District Nursing",
    postcode: "SE6 4RU",
    category: "adult",
    yearsOffered: [1, 2, 3],
    requiresDriver: true,
  ...
  {
    name: "Lambeth Community Paediatric Team",
    postcode: "SW2 1RW",
    category: "paediatric",
    yearsOffered: [2, 3],
    requiresDriver: true,
